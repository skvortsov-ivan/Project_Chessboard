...
//Brädet skriver du ut genom att låta varje svart ruta representeras av tecknet ◼︎ och varje vit ruta av tecknet ◻︎.
//Strukturera koden med minst två egna metoder, t.ex. ReadSize() och RenderBoard(int n).
//Git-flöde: arbeta på en separat branch (t.ex. feature/board) och skapa minst 1 Pull Request med en kort beskrivning av lösningen och en kort reflektion i PR-texten.
//Lägg till en README som beskriver hur man kör programmet.
//Använd ett AI-verktyg (t.ex. ChatGPT eller GitHub Copilot) för att:
